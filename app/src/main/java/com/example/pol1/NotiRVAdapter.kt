package com.example.pol1

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.example.pol1.databinding.ItemNotificationBinding

class NotiRVAdapter(private val notiList: ArrayList<Noti>): RecyclerView.Adapter<NotiRVAdapter.DataViewHolder>(){

    inner class DataViewHolder(private val viewBinding: ItemNotificationBinding): RecyclerView.ViewHolder(viewBinding.root) {
