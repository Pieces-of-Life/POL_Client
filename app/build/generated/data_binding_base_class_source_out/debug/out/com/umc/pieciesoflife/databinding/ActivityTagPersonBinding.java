...
public final class ActivityTagPersonBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ActivityTagPersonBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityTagPersonBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_tag_person, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityTagPersonBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.editText_person;
      EditText editTextPerson = ViewBindings.findChildViewById(rootView, id);
      if (editTextPerson == null) {
        break missingId;
      }
      ...
      id = R.id.textView_person;
      TextView textViewPerson = ViewBindings.findChildViewById(rootView, id);
      if (textViewPerson == null) {
        break missingId;
      }

      return new ActivityTagPersonBinding((ConstraintLayout) rootView, buttonBack, buttonGuide,
          buttonNext, buttonSkipQuestion, editTextPerson, textView1, textView2, textView3,
          textViewGuide, textViewPerson);
    }
