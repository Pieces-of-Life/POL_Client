...
public final class ActivityTagObjectBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final EditText editTextObject;
  ...
  private ActivityTagObjectBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageButton buttonBack, @NonNull Button buttonGuide, @NonNull Button buttonNext,
      @NonNull Button buttonSkipQuestion, @NonNull EditText editTextObject,
      @NonNull TextView textView1, @NonNull TextView textView2, @NonNull TextView textView3,
      @NonNull TextView textViewGuide, @NonNull TextView textViewObject) {
  ...
  @NonNull
  public static ActivityTagObjectBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityTagObjectBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_tag_object, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityTagObjectBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.editText_object;
      EditText editTextObject = ViewBindings.findChildViewById(rootView, id);
      if (editTextObject == null) {
        break missingId;
      }
      ...
      id = R.id.textView_object;
      TextView textViewObject = ViewBindings.findChildViewById(rootView, id);
      if (textViewObject == null) {
        break missingId;
      }

      return new ActivityTagObjectBinding((ConstraintLayout) rootView, buttonBack, buttonGuide,
          buttonNext, buttonSkipQuestion, editTextObject, textView1, textView2, textView3,
          textViewGuide, textViewObject);
    }
