...
public final class ActivityTagYearBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityTagYearBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageButton buttonBack, @NonNull Button buttonGuide, @NonNull Button buttonNext,
      @NonNull Button buttonSkipQuestion, @NonNull EditText editTextYear,
      @NonNull TextView textView1, @NonNull TextView textView2, @NonNull TextView textView3,
      @NonNull TextView textViewGuide, @NonNull TextView textViewYear) {
  ...
  @NonNull
  public static ActivityTagYearBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityTagYearBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_tag_year, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityTagYearBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.textView_year;
      TextView textViewYear = ViewBindings.findChildViewById(rootView, id);
      if (textViewYear == null) {
        break missingId;
      }

      return new ActivityTagYearBinding((ConstraintLayout) rootView, buttonBack, buttonGuide,
          buttonNext, buttonSkipQuestion, editTextYear, textView1, textView2, textView3,
          textViewGuide, textViewYear);
    }
